export const UploadIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        ...
        data-e2e=""
        height={height}
        style={{ padding: '1px 4px 0px', margin: ' 3px -11px 0px 6px' }}
        viewBox="0 0 48 48"
        fill="currentColor"
...
export const SearchIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const HomeActiveIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const GroupUserIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const GroupUserActiveIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveActiveIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TagIcon = ({ width = '1rem', height = '1rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MusicIcon = ({ width = '1rem', height = '1rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const HeartIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
...
export const HeartActiveIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg className={className} width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
        <path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" />
    </svg>
);
...
export const SaveActiveIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        style={{ marginLeft: '8px' }}
        className={className}
        width={width}
